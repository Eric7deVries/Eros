...
public static class IdentityApiEndpointRouteBuilderExtensions
{
		...
		where TUser : class, new()
	{
		...
		if (configureOptions.UseRegister)
		{
		...
		if (configureOptions.UseRefresh)
		{
		...
		if (configureOptions.UseConfirmEmail)
		{
		...
		if (configureOptions.UseResendConfirmationEmail)
		{
		...
		if (configureOptions.UseForgotPassword)
		{
		...
		if (configureOptions.UseResetPassword)
		{
		...
		var accountGroup = routeGroup.RequireAuthorization();
		
		if (configureOptions.Use2fa)
		{
